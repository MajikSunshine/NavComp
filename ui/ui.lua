...
function navcomp.ui:CreateUI (isLoad)
	...
	local text = iup.text { expand = "HORIZONTAL" }
	local note = iup.text { expand = "HORIZONTAL" }
...
function navcomp.ui:CreateEvasionIndicator ()
	local x = gkinterface.GetXResolution () / 2 - 75
	local y = gkinterface.GetYResolution () / 4 - 35
